...
$desc = $_POST['p_desc'];
//save info
$query=$pdo->prepare("INSERT INTO tbl_publisher(publisher_name,publisher_desc,publisher_active) values(?,?,?)");
$query->execute(([$name,$desc,"yes"]));
if($query){
            ...
            <div class="container card_style">
                <form action="" method="post">
                    <div class="card-body text-start">
                        <h4 class="text-center mt- mb-5">ເພີ່ມຂໍ້ມູນສຳນັກພິມໃໝ່</h4>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea type="text" class="form-control" rows="2" style="resize: none;" name="p_desc"></textarea>
                        </div>
                        <div class="row mb-3 mt-5">
                            <div class="col-6">
                                <button type="submit" class="btn btn-primary form-control" name="save">ບັນທຶກ</button>
                            </div>
                            <div class="col-6">
